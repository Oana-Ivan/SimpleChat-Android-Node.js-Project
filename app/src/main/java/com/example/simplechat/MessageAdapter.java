...
public class MessageAdapter extends RecyclerView.Adapter {
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        public SentMessageHolder(@NonNull View itemView) {
            super(itemView);
            messageTxt = itemView.findViewById(R.id.send_text);
        }
    }
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        public ReceivedMessageHolder(@NonNull View itemView) {
            ...
            messageTxt = itemView.findViewById(R.id.recivedTV);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_MESSAGE_RECEIVED:
                view = inflater.inflate(R.layout.item_recive_message, parent, false);
        ...
        try {
            if (message.getBoolean("isSent")) {
                ...
                if (message.has("message")) {
                    ...
                    Bitmap bitmap = getBitmapFromString(message.getString("name"));
                    imageHolder.imageView.setImageBitmap(bitmap);
                }
            }
        } catch (JSONException e) {
